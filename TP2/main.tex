...
Dans cette section, nous aborderons les différentes caractéristiques ou exigences nécessaires \cite{razzaquemiddleware} pour le bon fonctionnement d'un Middleware en général, et donc plus particulièrement pour notre Middleware. Ces exigences seront intégrées dans notre Middleware à travers les différents modules de celui-ci que nous détaillerons dans la prochaine section.
